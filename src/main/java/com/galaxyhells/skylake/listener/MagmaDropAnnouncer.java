...
public class MagmaDropAnnouncer {
    
    private static final Pattern RANKING_PATTERN = Pattern.compile("Ranking de Dano Causado no Magma Boss");
    ...
    public void onChatReceived(ClientChatReceivedEvent event) {
        ...
        if (!Boolean.TRUE.equals(SkyLake.optionsService.get(OptionType.MAGMA_DROP_ANNOUNCER))) return;
        
        String message = event.message.getUnformattedText();
        
        // Verifica se é a mensagem de ranking do Magma Boss
